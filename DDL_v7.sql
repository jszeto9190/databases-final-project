...
) ENGINE=InnoDB AUTO_INCREMENT=636550 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
CREATE TABLE `DriversRentals` (
  `driverIDRentalID` int(11) NOT NULL AUTO_INCREMENT,
  `driverID` int(11) NOT NULL,
  `rentalID` int(11) NOT NULL,
  PRIMARY KEY (`driverIDRentalID`,`driverID`,`rentalID`),
...
INSERT INTO `Makes` VALUES (1,'Toyota'),(2,'Tesla'),(3,'Honda'),(4,'Ford');
...
-- Dump completed on 2024-03-01 21:51:48
