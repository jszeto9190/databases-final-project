-- Created by Logan Knipple and Jason Szeto
-- CS340
-- 2/22/2024
-- Project Step 3 Data Definition Queries
...
) ENGINE=InnoDB AUTO_INCREMENT=636492 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
CREATE TABLE `DriversRentals` (
  ...
  PRIMARY KEY (`driversIDRentalsID`),
  KEY `fk_Drivers_has_Rentals_Rentals1_idx` (`rentalID`),
  KEY `fk_Drivers_has_Rentals_Drivers1_idx` (`driverID`),
  CONSTRAINT `fk_Drivers_has_Rentals_Drivers1` FOREIGN KEY (`driverID`) REFERENCES `Drivers` (`driverID`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_Drivers_has_Rentals_Rentals1` FOREIGN KEY (`rentalID`) REFERENCES `Rentals` (`rentalID`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `DriversRentals` VALUES (1,1,1),(2,2,2),(3,3,3),(4,4,4);
...
CREATE TABLE `Vehicles` (
  ...
  KEY `fk_Vehicles_Locations1_idx` (`locationID`),
...
-- Dump completed on 2024-02-15 17:29:10
